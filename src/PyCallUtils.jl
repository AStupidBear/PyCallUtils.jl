...
Base.getindex(o::PyObject, is...) = o.__getitem__(is)
Base.getindex(o::PyObject, s) = o.__getitem__(s)
Base.getindex(o::PyObject, s::Union{Symbol, AbstractString}) = o.__getitem__(s)
Base.setindex!(o::PyObject, v, s::Union{Symbol, AbstractString}) = o.__setitem__(s, v)
Base.setindex!(o::PyObject, v, s) = o.__setitem__(s, v)
Base.setindex!(o::PyObject, v, is...) = o.__setitem__(is, v)
